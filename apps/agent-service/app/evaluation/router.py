...
def _public_run(run: EvaluationRun) -> dict[str, Any]:
    ...
    return {
        ...
        "first_event_latency_ms": run.first_event_latency_ms,
        "first_visible_latency_ms": run.first_visible_latency_ms,
        "cancellation_latency_ms": run.cancellation_latency_ms,
