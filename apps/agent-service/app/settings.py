...
class Settings(BaseModel):
    ...
    rabbitmq_queue: str = Field(default="digital-human.presentation", alias="RABBITMQ_QUEUE")
    rabbitmq_publish_timeout_seconds: float = Field(default=0.35, alias="RABBITMQ_PUBLISH_TIMEOUT_SECONDS", gt=0, le=5)
