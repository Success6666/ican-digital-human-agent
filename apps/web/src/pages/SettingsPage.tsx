...
import { SettingsCatalog } from '../features/runtime/components/SettingsCatalog'
...
export function SettingsPage({ avatar }: SettingsPageProps) {
  ...
  return (
    <div className="page-stack">
      ...
      <SettingsCatalog configuration={configuration.configuration} isLoading={configuration.isLoading} />
    </div>
  )
}
